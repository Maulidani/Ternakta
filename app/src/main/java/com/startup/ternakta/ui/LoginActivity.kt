...
import com.startup.ternakta.ui.admin.LoginAdminActivity
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        if (sharedPref.getBoolean(PreferencesHelper.PREF_IS_LOGIN)) {
            ...
            } else if (sharedPref.getString(PreferencesHelper.PREF_USER_TYPE) == "store") {
                startActivity(Intent(applicationContext, LoginSellerActivity::class.java))
                finish()

            } else if (sharedPref.getString(PreferencesHelper.PREF_USER_TYPE) == "admin") {
                startActivity(Intent(applicationContext, LoginAdminActivity::class.java))
                finish()
