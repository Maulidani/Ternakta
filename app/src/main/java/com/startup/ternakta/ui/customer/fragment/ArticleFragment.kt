...
class ArticleFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        articleItem.add( ArticleModel("ayam bahagia",image1,image1))
        articleItem.add( ArticleModel("bibit ayam unggul","tidak adaji",image2))
        articleItem.add( ArticleModel("penjual ayam",image3,image3))
